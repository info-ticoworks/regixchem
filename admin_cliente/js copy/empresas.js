$(document).ready(function(){
    ...
    //Highlight de filas
    tablaEmpresas.on('mouseenter', 'tr', function(){
        $(document).find('tr').removeClass("dtSelected");
        $(tablaEmpresas.row(this).selector.rows).addClass("dtSelected");
    });
        ...
        if (pass1 == pass2){
            $.ajax({
                ...
                success: function(data){
                    ...
                    console.log(wsVerif);
                    if(opcion == 1){
                        tablaEmpresas.row.add([id,tipoCedula,nombre,apellido1,apellido2,telefono,correo,nombretipoUsuario,wsVerif,idPais,nombreEmpresa]).draw();
                        ...
                        tablaEmpresas.row(fila).data([id,tipoCedula,nombre,apellido1,apellido2,telefono,correo,nombretipoUsuario,wsVerif,idPais,nombreEmpresa]).draw();
