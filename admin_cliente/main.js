...
$(document).ready(function(){
    ...
    //Highlight de filas Tabla Personas
        ...
        if (pass1 == pass2){
            $.ajax({
                ...
                success: function(data){
                    ...
                    console.log(wsVerif);
                    if(opcion == 1){
                        tablaPersonas.row.add([id,nombre,apellido1,apellido2,telefono,correo,nombretipoUsuario,wsVerif,nombreLugarTrabajo]).draw();
                        //var row =  $("#tablaPersonas").DataTable().row.add(addrow).select().draw().node();
                        ...
                        tablaPersonas.row(fila).data([id,nombre,apellido1,apellido2,telefono,correo,nombretipoUsuario,wsVerif,nombreLugarTrabajo]).draw();
