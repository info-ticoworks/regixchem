                    ...
                    if(mysqli_num_rows($result) > 0){
                        ...
                        if ($listR == "Entrada") {
                            ...
                            if ($array['contar'] == 0) {
                                ...
                                $FechaPerfil->setLatitude($latitude);
                                $FechaPerfil->setLongitude($longitude);
                                        ...
                                        if(mysqli_num_rows($result) > 0){
                                            ...
                                            foreach ($userinfo as $user) {
                                                ...
                                                curl_setopt_array($curl, [
                                                    ...
                                                    CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su inicio de labores, sin embargo, no se registró ninguna ubicación.\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                    CURLOPT_HTTPHEADER => [
                                        ...
                                        if(mysqli_num_rows($result) > 0){
                                            ...
                                            foreach ($userinfo as $user) {
                                                ...
                                                curl_setopt_array($curl, [
                                                    ...
                                                    CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                    CURLOPT_CUSTOMREQUEST => "POST",
                                                    CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su inicio de labores desde la ubicación: https://www.google.com/maps/search/?api=1&query=$latitude%2C$longitude\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                    CURLOPT_HTTPHEADER => [
                                                    "Content-Type: application/json"
                                                    ],
                                                ]);
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                ...
                                                foreach ($userinfo as $user) {
                                                    ...
                                                    curl_setopt_array($curl, [
                                                        ...
                                                        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                        CURLOPT_CUSTOMREQUEST => "POST",
                                                        CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su finalización de labores, sin embargo, no se registró ninguna ubicación.\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                        CURLOPT_HTTPHEADER => [
                                                        "Content-Type: application/json"
                                                        ],
                                                    ]);
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                ...
                                                foreach ($userinfo as $user) {
                                                    ...
                                                    curl_setopt_array($curl, [
                                                        ...
                                                        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                        CURLOPT_CUSTOMREQUEST => "POST",
                                                        CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su finalización de labores desde la ubicación: https://www.google.com/maps/search/?api=1&query=$latitude%2C$longitude\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                        CURLOPT_HTTPHEADER => [
                                                        "Content-Type: application/json"
                                                        ],
                                                    ]);
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                ...
                                                foreach ($userinfo as $user) {
                                                    ...
                                                    curl_setopt_array($curl, [
                                                        ...
                                                        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                        CURLOPT_CUSTOMREQUEST => "POST",
                                                        CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su salida a descanso, sin embargo, no se registró ninguna ubicación.\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                        CURLOPT_HTTPHEADER => [
                                                        "Content-Type: application/json"
                                                        ],
                                                    ]);
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                                ...
                                                foreach ($userinfo as $user) {
                                                    ...
                                                    curl_setopt_array($curl, [
                                                        ...
                                                        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                        CURLOPT_CUSTOMREQUEST => "POST",
                                                        CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su salida a descanso desde la ubicación: https://www.google.com/maps/search/?api=1&query=$latitude%2C$longitude\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                        CURLOPT_HTTPHEADER => [
                                                        "Content-Type: application/json"
                                                        ],
                                                    ]);
                                                ...
                                                if(mysqli_num_rows($result) > 0){
                                                    ...
                                                    foreach ($userinfo as $user) {
                                                        ...
                                                        curl_setopt_array($curl, [
                                                            ...
                                                            CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                            CURLOPT_CUSTOMREQUEST => "POST",
                                                            CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su entrada después de descanso, sin embargo, no se registró ninguna ubicación.\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                            CURLOPT_HTTPHEADER => [
                                                            "Content-Type: application/json"
                                                            ],
                                                        ]);
                                                ...
                                                if(mysqli_num_rows($result) > 0){
                                                    ...
                                                    foreach ($userinfo as $user) {
                                                        ...
                                                        curl_setopt_array($curl, [
                                                            ...
                                                            CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
                                                            CURLOPT_CUSTOMREQUEST => "POST",
                                                            CURLOPT_POSTFIELDS => "{\n  \"message\":\"Hola {$user['nombre']}. El colaborador $nombre $apellido1 de $nombreEmpresa, con la cédula $cedula ha registrado su entrada después de descanso desde la ubicación: https://www.google.com/maps/search/?api=1&query=$latitude%2C$longitude\",\n  \"phone\":\"506{$user['telefono']}\"\n}",
                                                            CURLOPT_HTTPHEADER => [
                                                            "Content-Type: application/json"
                                                            ],
                                                        ]);
